#
#  Be sure to run `pod spec lint WTButton.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "AlienchangBlog"
  # s.authors            = { "AlienchangBlog" => "1217493217@qq.com" }
  # s.social_media_url   = "http://twitter.com/AlienchangBlog"
